// C++ code
// George Gesite 
// Round Robin Code Implementation of LED
// Started 1/11/22

// Sort LED through time/ lowest burst time goes first

// Number of LEDs are 10
int myLEDS[10];

// Round Robin Uses FIFO
// These is where you set the order of your LEDS, FIRST COME FIRST SERVE
// FIFO ORDER SET BY USER 
...
// Sort Burst Time to find Max Burst time
...
{ 
 ...
 int RR_count = MaxBurstTime/QT;
  ...
  // The FIFO is set on LINE 13 via array
  // This is the Start for Round Robin algo 
