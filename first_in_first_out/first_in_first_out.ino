// C++ code
// George Gesite 
// FIFO Code Implementation with LED ORDER INPUT VIA LIST
// Started 31/10/22

// These is where you set the order of your LEDS, FIRST COME FIRST SERVE
// myLED[0] comes first, myLEDs[1] second.... then myLEDs[9] comes last
...
{ 
  ...
  // LED FIFO using For Loop and Conditionals 
  // Iterate through myLEDs List as first come first serve
