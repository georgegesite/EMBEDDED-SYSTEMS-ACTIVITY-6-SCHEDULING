// C++ code
// George Gesite 
// SJF Code Implementation with LED ORDER INPUT VIA LIST
// Started 31/10/22
...
{ 
  ...
  //the for loops goes through the array of LEDS
  // executing first the LED with the least amount of burs time
  for(int i = 9; i>=0;i--)
  {
    if (myLEDS[i] == led1){
